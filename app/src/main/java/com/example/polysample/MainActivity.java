...
import com.example.polysample.origin.AsyncFileDownloader;
import com.example.polysample.origin.AsyncHttpRequest;
import com.example.polysample.origin.MtlLibrary;
import com.example.polysample.origin.MyGLSurfaceView;
import com.example.polysample.origin.ObjGeometry;
import com.example.polysample.origin.PolyApi;
import com.example.polysample.origin.RawObject;
...
public class MainActivity extends Activity {
  ...
  private static final String ASSET_ID = "7BNg01RWTfG";
  ...
  private static class ContextFactory implements GLSurfaceView.EGLContextFactory {
    ...
    public EGLContext createContext(
      ...
      Log.w("wjc", "creating OpenGL ES " + glVersion + " context");
