...
package com.example.polysample.origin;
...
public class MyGLUtils {
  ...
  public static final int SHORT_SIZE = 4;  // sizeof(short) is 2 bytes.
  ...
  public static int createIbo(IntBuffer data) {
    int[] ibos = new int[1];
    data.position(0);
    GLES20.glGenBuffers(1, ibos, 0);
    GLES20.glBindBuffer(GLES20.GL_ELEMENT_ARRAY_BUFFER, ibos[0]);
    GLES20.glBufferData(GLES20.GL_ELEMENT_ARRAY_BUFFER, data.capacity() * MyGLUtils.INT_SIZE,
